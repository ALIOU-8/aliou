...
use Illuminate\Support\Facades\Route;
    ...
    Route::prefix('paiement')->group(function () {
        ...
        // Route::get('/ajout', [PaiementController::class, 'ajout'])->name('paiement.ajout');
        // Route::get('/modif/{id}', [PaiementController::class, 'modif'])->name('paiement.modif');
        // Route::put('/update{id}', [PaiementController::class, 'update'])->name('paiement.update');
        // Route::get('/voir/{type}/{id}', [PaiementController::class, 'voir'])->name('paiement.voir');
        // Route::get('/payer/{id}', [PaiementController::class, 'payer'])->name('paiement.payer');
        // Route::post('/payement/{id}', [PaiementController::class, 'payement'])->name('paiement.payement');
        // Route::get('/recu/{id}', [PaiementController::class, 'recu'])->name('paiement.recu');
        // Route::put('/modif_payement/{id}', [PaiementController::class, 'modif_payement'])->name('paiement.modif.payement');
        // Route::get('/imposition/{type}/{id}', [PaiementController::class, 'imposition'])->name('paiement.imposition');
        // Route::post('/imposer/{type}/{id}', [PaiementController::class, 'imposer'])->name('paiement.imposer');
        // Route::get('/impots/search', [PaiementController::class, 'search'])->name('paiements.search');
    });
