...
class DashboardController extends Controller
{
    public function index(){
        ...
        return view('Admin::Dashboard.dashboard',compact('personnel','contribuable','bien','annee','user','bienrecencer','bienImposer','totalImpostsPayes','totalImpostsNonPayes','data','dataDonught'));
    }
