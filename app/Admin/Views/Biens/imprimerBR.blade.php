...
<body>
    <div class="container">
        ...
        <h4 style="text-align: center; margin-top: 10px;">Liste des biens recensés</h4>
        <table class="table">
            <thead>
                <tr>
                    <th>N°</th>
                ...
                @foreach ($bien as $key=> $biens )
                    <tr>
                        ...
                        <td>
                            @php
                                $types = [];
                                if($biens->recensementPatente) $types[] = 'Patente';
                                if($biens->recensementLicence) $types[] = 'Licence';
                                if($biens->recensementCfu) $types[] = 'Cfu';
                                if($biens->recensementTpu) $types[] = 'Tpu';
                            @endphp
                            {{ implode (' & ', $types) }}
                        </td>
                    </tr>
