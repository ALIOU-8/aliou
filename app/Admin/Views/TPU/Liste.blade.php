...
function fetchRecensements() {
    ...
    fetch("{{ route('recensements.search') }}?query=" + query)
                ...
                data.forEach((recensement, index) => {
                    let row = `
                        <tr>
                            ...
                            <td class="d-flex justify-content-center gap-2">
                                <a href="/tpu/voir/${recensement.id}" class="btn btn-outline-success btn-sm">Voir<i class="bx bx-show"></i></a>
                                <a href="/impot/imposition/${recensement.id}" class="btn btn-outline-success btn-sm">Imposer<i class="bx bx-money"></i></a>
                                <a href="/tpu/modif/${recensement.id}" class="btn btn-outline-success btn-sm">Modifier<i class="bx bx-edit"></i></a>
                            </td>
                        </tr>
                    `;
                    tbody.innerHTML += row;
