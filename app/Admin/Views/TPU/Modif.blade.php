            ...
            <div class="col-md-12 mb-5">
                <div class="card border border-light">
                    <div class="card-body">
                        ...
                        <div class="h6 mb-3 text-danger"><span>NB:<span class="required-start text-danger text-bolder p-2">*</span>Tous les champs marqués d'une étoile sont obigatoires</span></div>                        <form action="{{route("tpu.update",$recencement_tpu->uuid)}}" method="POST" class="form">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="bien_id">Numero du bien<span class="required-start text-danger text-bolder p-2">*</span><span class="required-start text-danger text-bolder p-2">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="annee_id">Année de recensement<span class="required-start text-danger text-bolder p-2">*</span><span class="required-start text-danger text-bolder p-2">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="categorie">Catégorie<span class="required-start text-danger text-bolder p-2">*</span><span class="required-start text-danger text-bolder p-2">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="Date_rdv">Date du Rendez-vous<span class="required-start text-danger text-bolder p-2">*</span><span class="required-start text-danger text-bolder p-2">*</span></label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="Date_recensement">Date de Rencensement<span class="required-start text-danger text-bolder p-2">*</span><span class="required-start text-danger text-bolder p-2">*</span></label>
