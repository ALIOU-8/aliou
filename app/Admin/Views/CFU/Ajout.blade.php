                    ...
                    <div class="card-body">
                        ...
                        <form action="" class="form">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="numBoutique">Statut</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="numBoutique">Nombre d'étage</label>
                                    <input class="form-control" type="text" name="numBoutique">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="libelle">Surface</label>
                                    <input class="form-control" type="text" name="libelle">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="numBoutique">Nature fondation</label>
                                    <input class="form-control" type="text" name="numBoutique">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="libelle">Nature mur</label>
                                    <input class="form-control" type="text" name="libelle">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="numBoutique">Nature toit</label>
                                    <input class="form-control" type="text" name="numBoutique">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label" for="libelle">Nombre unité</label>
                                    <input class="form-control" type="text" name="libelle">
                                </div>                
                                <div class="col-md-6 mb-3">
